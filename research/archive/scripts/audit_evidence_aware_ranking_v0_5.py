"""
RAKSHAK Evidence-Aware Ranking Audit v0.5
=========================================
...
OUTPUT_DIR = PROJECT_ROOT / "experiments" / "sif_evidence_aware_ranking_v0.5_audit"
...
def main() -> None:
    ...
    report = {
        "experiment": "RAKSHAK Evidence-Aware Ranking Audit v0.5",
    ...
    print("=" * 78)
    print("RAKSHAK EVIDENCE-AWARE RANKING AUDIT v0.5")
    print("=" * 78)
